...
par(mfrow=c(1,2), mar=c(3,4,1,1))
data=0:3000
res1=logit.sel(x=data, infl1=1000, infl2=2000, pos=TRUE)
res2=logit.sel(x=data, infl1=1000, infl2=2000, pos=FALSE) 
...
par(mfrow=c(1,2), mar=c(3,4,1,1))
data=0:3000
res1=logit.sel(x=data, infl1=1000, infl2=2000, pos=TRUE, lv=0.2,uv=0.8)
res2=logit.sel(x=data, infl1=1000, infl2=2000, pos=FALSE, lv=0.2,uv=0.8) 
...
data=0:3000
res1=plat.logit.sel(x=data, infl1=500, infl2=1000, infl3=2000, infl4=2500, pos=TRUE)
res2=plat.logit.sel(x=data, infl1=500, infl2=1000, infl3=2000, infl4=2500, pos=FALSE) 
...
data=0:3000
res1=plat.logit.sel(x=data, infl1=500, infl2=1000, infl3=2000, infl4=2500, pos=TRUE, lv=0.2,uv=0.8)
res2=plat.logit.sel(x=data, infl1=500, infl2=1000, infl3=2000, infl4=2500, pos=FALSE, lv=0.2,uv=0.8) 
...
data=0:3000
res1=plat.logit.sel(x=data, infl1=500, infl2=1000, infl3=2000, infl4=2500, pos=TRUE, lv=c(0.2,0.4),uv=0.8)
res2=plat.logit.sel(x=data, infl1=500, infl2=1000, infl3=2000, infl4=2500, pos=FALSE, lv=0.2,uv=c(0.8,0.6)) 
