...
data=0:3000
res1=full.sel(x=data, infl1=1500, pos=TRUE)
res2=full.sel(x=data, infl1=1500, pos=FALSE)
...
axis(side=1,at=seq(0,3000,by=1000))
axis(side=4,at=c(0,0.5,1), las=1)
@  
\end{center}
\vspace{-30pt}
...
par(mfrow=c(1,2), mar=c(3,4,1,1))
data=0:3000
res1=full.sel(x=data, infl1=1500, pos=TRUE, lv=0.2,uv=0.8)
res2=full.sel(x=data, infl1=1500, pos=FALSE, lv=0.2,uv=0.8)
...
par(mfrow=c(1,2), mar=c(3,4,1,1))
data=0:3000
res1=plat.full.sel(infl1=1000, infl2=2000, x=data, pos=TRUE)
res2=plat.full.sel(infl1=1000, infl2=2000, x=data, pos=FALSE) 
...
<<fig=F,echo=T, eval=T, results=hide>>=
data=0:3000
plat.full.sel(x=data, infl1=1000, infl2=2000, pos=TRUE, lv=0.2,uv=0.8)
plat.full.sel(x=data, infl1=1000, infl2=2000, pos=FALSE, lv=0.2,uv=0.8) 
@ 
\begin{figure}[h]
\vspace{-20pt}
\begin{center}
...
par(mfrow=c(1,2), mar=c(3,4,1,1))
data=0:3000
res1=plat.full.sel(infl1=1000, infl2=2000, x=data, pos=TRUE, lv=0.2,uv=0.8)
res2=plat.full.sel(infl1=1000, infl2=2000, x=data, pos=FALSE, lv=0.2,uv=0.8) 
...
<<fig=F,echo=T, eval=T, results=hide>>=
data=0:3000
plat.full.sel(x=data, infl1=1000, infl2=2000, pos=TRUE, lv=c(0.2,0.4),uv=0.8)
plat.full.sel(x=data, infl1=1000, infl2=2000, pos=FALSE, lv=0.2,uv=c(0.8,0.6)) 
@ 
\begin{figure}[h]
\vspace{-20pt}
\begin{center}
...
par(mfrow=c(1,2), mar=c(3,4,1,1))
data=0:3000
res1=plat.full.sel(x=data, infl1=1000, infl2=2000, pos=TRUE, lv=c(0.2,0.4),uv=0.8)
res2=plat.full.sel(x=data, infl1=1000, infl2=2000, pos=FALSE, lv=0.2,uv=c(0.8,0.6)) 
...
par(mfrow=c(1,2), mar=c(3,4,1,1))
data=0:3000
res1=ramp.sel(x=data, infl1=1000, infl2=2000, pos=TRUE)
res2=ramp.sel(x=data, infl1=1000, infl2=2000, pos=FALSE) 
...
<<fig=F,echo=T, eval=T, results=hide>>=
ramp.sel(x=data, infl1=1000, infl2=2000, pos=TRUE, lv=0.2,uv=0.8)
ramp.sel(x=data, infl1=1000, infl2=2000, pos=FALSE, lv=0.2,uv=0.8) 
@ 
...
par(mfrow=c(1,2), mar=c(3,4,1,1))
data=0:3000
res1=ramp.sel(x=data, infl1=1000, infl2=2000, pos=TRUE, lv=0.2,uv=0.8)
res2=ramp.sel(x=data, infl1=1000, infl2=2000, pos=FALSE, lv=0.2,uv=0.8) 
...
<<fig=F,echo=T, eval=T, results=hide>>=
data=0:3000
plat.ramp.sel(x=data, infl1=500, infl2=1000, infl3=2000, infl4=2500, pos=TRUE)
plat.ramp.sel(x=data, infl1=500, infl2=1000, infl3=2000, infl4=2500, pos=FALSE) 
@ 
\begin{figure}[h]
\vspace{-20pt}
\begin{center}
...
par(mfrow=c(1,2), mar=c(3,4,1,1))
data=0:3000
res1=plat.ramp.sel(x=data, infl1=500, infl2=1000, infl3=2000, infl4=2500, pos=TRUE)
res2=plat.ramp.sel(x=data, infl1=500, infl2=1000, infl3=2000, infl4=2500, pos=FALSE) 
...
<<fig=F,echo=T, eval=T, results=hide>>=
data=0:3000
plat.ramp.sel(x=data, infl1=500, infl2=1000, infl3=2000, infl4=2500, pos=TRUE, lv=0.2,uv=0.8)
plat.ramp.sel(x=data, infl1=500, infl2=1000, infl3=2000, infl4=2500, pos=FALSE, lv=0.2,uv=0.8) 
@ 
\begin{figure}[h]
\vspace{-20pt}
\begin{center}
...
par(mfrow=c(1,2), mar=c(3,4,1,1))
data=0:3000
res1=plat.ramp.sel(x=data, infl1=500, infl2=1000, infl3=2000, infl4=2500, pos=TRUE, lv=0.2,uv=0.8)
res2=plat.ramp.sel(x=data, infl1=500, infl2=1000, infl3=2000, infl4=2500, pos=FALSE, lv=0.2,uv=0.8) 
...
<<fig=F,echo=T, eval=T, results=hide>>=
data=0:3000
plat.ramp.sel(x=data, infl1=500, infl2=1000, infl3=2000, infl4=2500, pos=TRUE, lv=c(0.2,0.4),uv=0.8)
plat.ramp.sel(x=data, infl1=500, infl2=1000, infl3=2000, infl4=2500, pos=FALSE, lv=0.2,uv=c(0.8,0.6))
@ 
\begin{figure}[h]
\vspace{-20pt}
\begin{center}
...
par(mfrow=c(1,2), mar=c(3,4,1,1))
data=0:3000
res1=plat.ramp.sel(x=data, infl1=500, infl2=1000, infl3=2000, infl4=2500, pos=TRUE, lv=c(0.2,0.4),uv=0.8)
res2=plat.ramp.sel(x=data, infl1=500, infl2=1000, infl3=2000, infl4=2500, pos=FALSE, lv=0.2,uv=c(0.8,0.6)) 
...
par(mfrow=c(1,2), mar=c(3,4,1,1))
data=0:3000
res1=logit.sel(x=data, infl1=1000, infl2=2000, pos=TRUE,beta=0.01)
res2=logit.sel(x=data, infl1=1000, infl2=2000, pos=FALSE,beta=0.01) 
...
axis(side=1,at=seq(0,3000,by=1000))
axis(side=4,at=c(0,0.5,1), las=1)
text(x=3000,y=0.5,labels=expression(x[50]),adj=c(0.7,-0.3))
lines(x=c(5000,1500,1500), y=c(0.5,0.5,-1000), lty=3)
...
<<fig=F,echo=T, eval=T, results=hide>>=
logit.sel(x=data, infl1=1000, infl2=2000, pos=TRUE, lv=0.2,uv=0.8)
logit.sel(x=data, infl1=1000, infl2=2000, pos=FALSE, lv=0.2,uv=0.8) 
@ 
...
par(mfrow=c(1,2), mar=c(3,4,1,1))
data=0:3000
res1=logit.sel(x=data, infl1=1000, infl2=2000, pos=TRUE, lv=0.2,uv=0.8,beta=0.01)
res2=logit.sel(x=data, infl1=1000, infl2=2000, pos=FALSE, lv=0.2,uv=0.8,beta=0.01) 
...
<<fig=F,echo=T, eval=T, results=hide>>=
data=0:3000
plat.logit.sel(x=data, infl1=500, infl2=1000, infl3=2000, infl4=2500, pos=TRUE)
plat.logit.sel(x=data, infl1=500, infl2=1000, infl3=2000, infl4=2500, pos=FALSE) 
@ 
\begin{figure}[h]
\vspace{-20pt}
\begin{center}
...
data=0:3000
res1=plat.logit.sel(x=data, infl1=500, infl2=1000, infl3=2000, infl4=2500, pos=TRUE,beta=0.01)
res2=plat.logit.sel(x=data, infl1=500, infl2=1000, infl3=2000, infl4=2500, pos=FALSE,beta=0.01) 
...
axis(side=4,at=c(0,0.5,1), las=1)
text(x=3000,y=0.5,labels=expression(x[50]),adj=c(0.7,-0.3))
lines(x=c(5000,750), y=c(0.5,0.5), lty=3)
lines(x=c(750,750), y=c(0.5,-1000), lty=3)
lines(x=c(2250,2250), y=c(0.5,-1000), lty=3)
@  
\end{center}
...
<<fig=F,echo=T, eval=T, results=hide>>=
data=0:3000
plat.logit.sel(x=data, infl1=500, infl2=1000, infl3=2000, infl4=2500, pos=TRUE, lv=0.2,uv=0.8)
plat.logit.sel(x=data, infl1=500, infl2=1000, infl3=2000, infl4=2500, pos=FALSE, lv=0.2,uv=0.8) 
@ 
\begin{figure}[h]
\vspace{-20pt}
\begin{center}
...
data=0:3000
res1=plat.logit.sel(x=data, infl1=500, infl2=1000, infl3=2000, infl4=2500, pos=TRUE, lv=0.2,uv=0.8,beta=0.01)
res2=plat.logit.sel(x=data, infl1=500, infl2=1000, infl3=2000, infl4=2500, pos=FALSE, lv=0.2,uv=0.8,beta=0.01) 
...
<<fig=F,echo=T, eval=T, results=hide>>=
data=0:3000
plat.logit.sel(x=data, infl1=500, infl2=1000, infl3=2000, infl4=2500, pos=TRUE, lv=c(0.2,0.4),uv=0.8)
plat.logit.sel(x=data, infl1=500, infl2=1000, infl3=2000, infl4=2500, pos=FALSE, lv=0.2,uv=c(0.8,0.6))
@ 
\begin{figure}[h]
\vspace{-20pt}
\begin{center}
...
data=0:3000
res1=plat.logit.sel(x=data, infl1=500, infl2=1000, infl3=2000, infl4=2500, pos=TRUE, lv=c(0.2,0.4),uv=0.8, beta=0.01)
res2=plat.logit.sel(x=data, infl1=500, infl2=1000, infl3=2000, infl4=2500, pos=FALSE, lv=0.2,uv=c(0.8,0.6),beta=0.01) 
find.beta(minv=500, maxv=1000)
par(mfrow=c(1,2), mar=c(3,4,1,1))
plot(res1~data,type='l',lwd=2, col='black', ylab="probability",
        main="", xaxt='n', yaxt='n', ylim=ylim, xlim=xlim, xlab="")
axis(side=1,at=seq(0,3000,by=1000), las=1)
...
axis(side=4,at=c(0,0.5,1), las=1)
text(x=3000,y=0.5,labels=expression(x[50]),adj=c(0.7,-0.3))
lines(x=c(5000,2500), y=c(0.5,0.5), lty=3)
lines(x=c(2100,750), y=c(0.5,0.5), lty=3)
lines(x=c(750,750), y=c(0.5,-1000), lty=3)
