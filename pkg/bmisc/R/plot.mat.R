...
plot.mat=function(object, ylab="Probabilité",xlab="Longueur à la fourche (mm)", se.pred=TRUE, 
        leg=TRUE, ref=TRUE, range.x=c("data","full"), warn.val=TRUE)
{
...
#        if(ref){
#            x.leg2=x.leg1+(x.leg1*2)
#            
#            polygon(x=c(x.leg1,x.leg2,x.leg2,x.leg1), y=c(0.96,0.96,0.66,0.66), col="white")
#        }
