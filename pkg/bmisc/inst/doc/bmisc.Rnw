...
the construct of a \code{\LinkA{list}{list}} where the first element is the name one of the three types of equation. 
The following elements of the \code{\LinkA{list}{list}} are specific to the type of equation:
\begin{itemize}
