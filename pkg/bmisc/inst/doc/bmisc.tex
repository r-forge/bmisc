...
\item[Description]\AsIs{This package has different functions that I have accumulated with time. Thi is the Alpha version.}
...
\item[Repository/R-Forge/Revision]\AsIs{93}
\end{description}
...
\item[\code{enc.utf8}] logical; if \code{TRUE}, \code{\LinkA{iconv}{iconv}(x,"utf-8")} is used for 
plotting \code{main}, \code{ylab}, and \code{xlab}. Read 'details'. 
