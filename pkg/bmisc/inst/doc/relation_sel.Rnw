...
\noindent These relations are the simplest that can be used. While `const' stands for a constant probability of one, the other two 
have "all-or-nothing" types of probabilities. One or two thresholds (inflection points) need to be defined. 
...
\item[full.sel]\verb#(infl1, x, neg=FALSE, lv=0, uv=1)#
\item[plat.full.sel]\verb#(infl1, infl2, x, neg=FALSE, lv=c(0,0), uv=c(1,1))#
\end{description}
...
all fonctions have \verb#neg=FALSE#, \verb#lv=c(0,0)#, and \verb#uv=c(0,0)#.\\*
...
data=0:3000
full.sel(infl1=1500, x=data, neg=FALSE) ## in blue
full.sel(infl1=1500, x=data, neg=TRUE) ## in red
@ 
\begin{figure}[h]
\begin{center}
...
<<fig=F,echo=T, eval=T, results=hide>>=
data=0:3000
plat.full.sel(infl1=1000, infl2=2000, x=data, neg=FALSE) ## in gray
plat.full.sel(infl1=1000, infl2=2000, x=data, neg=TRUE) ## in red
@ 
\begin{figure}[h]
\begin{center}
<<fig=T,echo=F, eval=T,width=5, height=4>>=
data=0:3000
res1=plat.full.sel(infl1=1000, infl2=2000, x=data, neg=FALSE) ## in gray
res2=plat.full.sel(infl1=1000, infl2=2000, x=data, neg=TRUE) ## in red
plot(res1~data,type='l',lwd=2, col='gray', ylab="probability",xlab="x",
        main="")
...
\begin{description}
\item[ramp.sel]\verb#(infl1, infl2, x, neg=FALSE)#
\item[plat.ramp.sel]\verb#(infl1, infl2, infl3, infl4, x, neg=FALSE)#
\end{description}
...
<<fig=F,echo=T, eval=T, results=hide>>=
ramp.sel(infl1=1000, infl2=1500, x=data, neg=FALSE) ## in gray
ramp.sel(infl1=1000, infl2=1500, x=data, neg=TRUE) ## in red
@ 
\begin{figure}[h]
\begin{center}
<<fig=T,echo=F, eval=T,width=5, height=4>>=
...
<<fig=F,echo=T, eval=T, results=hide>>=
data=0:3000
plat.ramp.sel(infl1=1000, infl2=1500, infl3=2000, infl4=2500, x=data, neg=FALSE) ## in gray
plat.ramp.sel(infl1=1000, infl2=1500, infl3=2000, infl4=2500, x=data, neg=TRUE) ## in red
@ 
\begin{figure}[h]
\begin{center}
<<fig=T,echo=F, eval=T,width=5, height=4>>=
data=0:3000
res1=plat.ramp.sel(infl1=1000, infl2=1500, infl3=2000, infl4=2500, x=data, neg=FALSE) ## in gray
res2=plat.ramp.sel(infl1=1000, infl2=1500, infl3=2000, infl4=2500, x=data, neg=TRUE) ## in red
plot(res1~data,type='l',lwd=2, col='gray', ylab="probability",xlab="x",
        main="")
points(res2~data,type='l',lwd=2, col='red', ylab="probability",xlab="x",
        lty=2)
...
\begin{description}
\item[logit.sel]\verb#(infl1, infl2, x, neg=FALSE)#
\item[plat.logit.sel]\verb#(infl1, infl2, infl3, infl4, x, neg=FALSE)#
\end{description}
where \verb#infl1# to \verb#infl4# are the inflection points, \verb#x# is a numeric vector for which probabilities are 
estimated and \verb#ptv# indicates if the trend is positive  (\verb#TRUE#) or negative (\verb#FALSE#).\\*
...
<<fig=F,echo=T, eval=T, results=hide>>=
logit.sel(infl1=1000, infl2=1500, x=data, neg=FALSE) ## in gray
logit.sel(infl1=1000, infl2=1500, x=data, neg=TRUE) ## in red
@ 
\begin{figure}[h]
\begin{center}
<<fig=T,echo=F, eval=T,width=5, height=4>>=
...
<<fig=F,echo=T, eval=T, results=hide>>=
data=0:3000
plat.logit.sel(infl1=1000, infl2=1500, infl3=2000, 
	infl4=2500, x=data, neg=FALSE) ## in gray
plat.logit.sel(infl1=1000, infl2=1500, infl3=2000, infl4=2500, x=data, neg=TRUE) ## in red
@ 
\begin{figure}[h]
\begin{center}
<<fig=T,echo=F, eval=T,width=5, height=4>>=
data=0:3000
res1=plat.logit.sel(infl1=1000, infl2=1500, infl3=2000, infl4=2500, x=data, neg=FALSE) ## in gray
res2=plat.logit.sel(infl1=1000, infl2=1500, infl3=2000, infl4=2500, x=data, neg=TRUE) ## in red
