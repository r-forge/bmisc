...
s.an=function(object,mat=c(800,1100,50), fsel.max=NA, fsel.min=NA, M=NA,last.age=NA, f.MSP=NA, lstart=NA){
    
    
    parms=list(mat=mat, fsel.max=fsel.max, fsel.min=fsel.min, M=M,last.age=last.age, f.MSP=f.MSP, lstart=lstart)
